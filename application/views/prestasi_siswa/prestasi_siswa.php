		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form class="form-horizontal" role="form" method="post" action="<?php echo base_url('index.php/c_prestasi_siswa/tampil');?>">
						<div class="row">
							<div class="col-xs-12 col-sm-12">
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										<select required data-placeholder="- Pilih Nama Siswa - "  class="chosen-select form-control" id="form-field-select-3"  tabindex="-1"  name="id_siswa">
